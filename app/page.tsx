...
export default function Page() {
  ...
  return (
    <div className={`${darkMode ? "dark bg-gray-900 text-white" : "bg-gray-50 text-gray-900"} min-h-screen`}>
      <Navbar />

      {/* --------------------- HERO --------------------- */}
      <header
        className={`relative w-full overflow-hidden pb-10 transition-all
        ${
          darkMode
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="mt-5 flex justify-center md:justify-start gap-3">
              ...
              <a
                href="/alphabetical"
                className={`px-5 py-3 rounded-full border flex items-center gap-2 transition
                ${
                  darkMode
          ...
          <div className="flex-1 flex justify-center">
            <img src={HERO_IMG} className="w-full max-w-sm md:max-w-md object-contain drop-shadow-2xl rounded-xl" />
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4">
        ...
        <div id="search" className="sticky top-6 z-40 mt-10">
          <div
            ...
            ${darkMode ? "bg-gray-800/60 border-gray-700" : "bg-white/70 border-gray-200"}`}
          >
            <div className="flex flex-col md:flex-row gap-3">

              <input
                className={`flex-1 p-3 rounded-xl outline-none focus:ring-2
                ${darkMode ? "bg-gray-900 text-white focus:ring-blue-500" : "bg-white text-gray-800 focus:ring-blue-500"}`}
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={`${darkMode ? "bg-gray-700" : "bg-gray-200"} px-4 py-3 rounded-xl`}
                >
                  Clear
                </button>
                ...
                <button
                  ...
                  className={`${darkMode ? "bg-gray-700" : "bg-gray-100"} px-4 py-3 rounded-xl`}
                >
                  {darkMode ? "Light" : "Dark"}
                </button>
              </div>
        ...
        <section className="mt-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="/alphabetical" className="glass-card p-4 group flex-col flex gap-3">
            ...
            <a href="/gallery" className="glass-card p-4 group flex-col flex gap-3">
            ...
            <a href="/work" className="glass-card p-4 group flex-col flex gap-3">
            ...
            <a href="/contact" className="glass-card p-4 group flex-col flex gap-3">
        ...
        <section className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <motion.div
            ...
            className="glass-card p-4 col-span-1 md:col-span-2"
          >
            <div className="flex justify-between">
              ...
              <a href={SNAPSHOT_IMG} className="underline text-sm" target="_blank">
                Open image
              </a>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Total voters & details</p>
              </div>
            </div>
            ...
            <div className="flex gap-2 mt-auto">
              <a href="/alphabetical" className="flex-1 bg-blue-600 text-white px-3 py-2 rounded-md text-sm flex items-center gap-1 justify-center">
                <LucideList size={14} /> Alphabetical
              </a>

              <button
                onClick={() => window.print()}
                className="px-3 py-2 bg-gray-200 dark:bg-gray-700 rounded-md text-sm flex items-center gap-1"
              >
        ...
        <section id="results" className="mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filtered.map((v) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                className={`${darkMode ? "bg-gray-800" : "bg-white"} p-4 rounded-xl shadow cursor-pointer`}
          ...
          <div id="print-area" className="hidden print:block px-6">
            <h2 className="text-xl font-semibold mb-4">Printed Voter List ({filtered.length})</h2>

            <div className="columns-2 gap-6">
              {filtered.map((v) => (
                <div key={v.voter_id} className="break-inside-avoid border p-3 mb-4 rounded-lg text-sm">
