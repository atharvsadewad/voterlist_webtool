...
export default function Page() {
  ...
  // Images
  const HERO_IMG = "/IMG-20251123-WA0004.jpg?v=12345";
  ...
  return (
    <>
      {/* ⭐ KEY CHANGE: Added 'print:hidden' here. 
        This completely removes the UI from the flow when printing, 
        preventing blank pages.
      */}
      <div className={`print:hidden min-h-screen transition-all ${darkMode ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}>
        <Navbar />
...
>
  ...
  <div className="text-xs text-gray-500 dark:text-gray-400">View voters by booth</div>
      ...
      {/* ⭐ FIXED PRINT AREA 
        Moved outside the main div so it is the ONLY thing rendered when printing.
      */}
